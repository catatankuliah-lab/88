...
<div class="row">
    <div class="col-md-12 col-lg-12">
        <div class="card-body">
            <h5 class="card-title mb-3">List Surat Jalan</h5>
            <h6 class="card-subtitle">
                Klik <a style="font-weight: bolder;" href="<?= base_url('admingudang/beritaacara/create') ?>">disini</a> untuk menambahkan Surat Jalan, atau klik <a style="font-weight: bolder;" href="<?= base_url('admingudang/beritaacara/scan') ?>">disini</a> untuk upload berkas Surat Jalan,
            </h6>
