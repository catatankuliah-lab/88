        ...
        <div class="card-body">
            ...
            <div class="row mt-4">
                ...
                <div class="col-12 mb-3">
                    ...
                    <input class="form-control custom-shadow custom-radius border-0 bg-white text-secondary px-4" type="text" style="height: 50px !important; font-size: 14px;" readonly placeholder="Masukan Nama Lengkap Disini">
                </div>
                <div class="col-12">
                ...
                <div class="col-12">
                    ...
                    <textarea name="" id="" cols="30" rows="10" readonly class="form-control custom-shadow border-0 bg-white text-secondary px-4" type="text" style="height: 150px !important; font-size: 14px; border-radius: 25px;"></textarea>
                </div>
            </div>
        </div>
    </div>
