...
<div class="row">
    <div class="col-md-12 col-lg-12">
        <div class="card-body">
            <h5 class="card-title">Tambah Data Admin Gudang</h5>
            <div class="row mt-4">
                <div class="col-12 mb-3">
                    <label for="nama" class="h6">Foto Admin Gudang</label><br>
                ...
                <div class="col-12 mb-3">
                    ...
                    <input class="form-control custom-shadow custom-radius border-0 bg-white text-secondary px-4" type="text" style="height: 50px !important; font-size: 14px;" placeholder="Masukan NIK Disini">
                </div>
                <div class="col-12 mb-3">
