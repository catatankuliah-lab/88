...
<div class="container-fluid">
    <div class="card-group">
        <div class="card border-right mr-2">
            <div class="card-body">
        ...
        <div class="card border-right mx-2">
            <div class="card-body">
                <div class="d-flex d-lg-flex d-md-block align-items-center">
                    <div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-start">
                        <h4 class="card-title my-3">Penjualan Bulan Ini</h4>
                    </div>
                    <div class="pl-4 mb-5">
                        <div class="stats ct-charts position-relative" style="height: 500px;"></div>
                    </div>
                </div>
            </div>
        </div>
