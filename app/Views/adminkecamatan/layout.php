...
<body>
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item <?= $menu3 ?>">
                            <a class="sidebar-link" onclick="bast()" aria-expanded="false"><i data-feather="file" class="feather-icon"></i><span class="hide-menu">BAST
                                </span>
                            </a>
                        </li>
                    </ul>
    ...
    <script>
        function dashboard() {
            window.location.href = "<?= base_url('adminkecamatan') ?>"
        }

        function sptjm() {
            window.location.href = "<?= base_url('adminkecamatan/sptjm') ?>"
        }

        function bast() {
            window.location.href = "<?= base_url('adminkecamatan/bast') ?>"
        }
    </script>
</body>
