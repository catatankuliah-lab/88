...
$routes->group('admin', function ($routes) {
    ...
    $routes->get('ag/delete-ag/(:segment)', 'AdminController::delete-ag/$1');
    ...
    $routes->get('ad/delete-ad/(:segment)', 'AdminController::delete-ad/$1');
    ...
    $routes->get('tp/delete-tp/(:segment)', 'AdminController::delete-tp/$1');
    ...
    $routes->get('so/delete-so/(:segment)', 'AdminController::delete-so/$1');
    ...
    $routes->get('do/delete-do/(:segment)', 'AdminController::delete-do/$1');
    ...
    $routes->get('spm/delete-spm/(:segment)', 'AdminController::delete-spm/$1');
    ...
    $routes->get('ba/delete-ba/(:segment)', 'AdminController::delete-ba/$1');
    ...
    $routes->get('sj/delete-sj/(:segment)', 'AdminController::delete-sj/$1');
    ...
    $routes->get('tt/delete-tt/(:segment)', 'AdminController::delete-tt/$1');
    ...
    $routes->get('sptjm/delete-sptjm/(:segment)', 'AdminController::delete-sptjm/$1');
});
